    ...
    const { data: businessData, refetch } = useQuery(
        ...
        async ({ signal }) => {
            return await axiosPrivate
                .get(USER_API_URL.deleteBusinessView, {
                    params: {
            ...
            <Card className='shadow border border-1 mt-4'>
                <List>
                    ...
                    <ListItem>
                        ...
                        <span>{businessData?.businessEmail ? businessData?.businessEmail : '-'}</span>
                    </ListItem>
                    <ListItem>
            ...
            <Card className='shadow border border-1'>
                <List>
                    ...
                    <ListItem>
                        ...
                        <ListItemText sx={{ flex: '1 0 auto' }}>{businessData?.phone ? businessData?.phone : '-'}</ListItemText>
                    </ListItem>
                    <ListItem>
                        <ListItemText sx={{ flex: '0 0 120px' }}>email : </ListItemText>
                        <ListItemText sx={{ flex: '1 0 auto' }}>{businessData?.email ? businessData?.email : '-'}</ListItemText>
                    </ListItem>
                    <ListItem>
...
export default ArchivedBusinessView